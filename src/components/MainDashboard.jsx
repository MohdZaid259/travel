...
export default function MainDashboard() {
  ...
  return (
    <div className="w-full max-w-[320px] bg-gray-50 text-black rounded-3xl overflow-hidden border border-gray-200">
      <div className="flex flex-col h-[600px] overflow-y-auto">
        ...
        <div className="mt-auto p-3 bg-white flex justify-between items-center border-t border-gray-200">
